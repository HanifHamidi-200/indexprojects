...
namespace AdjacentSteppings2
{
    public partial class Form1 : Form
    {
        ...
        private int cENEMY = 4, cFIREBALL = 7, cHOLDPERSON = 10, cDYING = 11, cSTONE1 = 13, cSTONE2 = 14, cYOU = 15, cNULLGATE = 17;
        ...
        private void fCompleteFireball(int nCol, int nRow)
        {
        ...
        private void fReset()
        {
            ...
            do
            {
                ...
                if (nRow == 1)
                {
                    ...
                    fStick(nCol, nRow, cSTONE1-1, nRotate);
                }
                else
                {
            ...
            for (int i = 1; i <= mnEnemies; i++)
            {
                ...
                fStick(nCol, nRow, cENEMY, nRotate);
            }
