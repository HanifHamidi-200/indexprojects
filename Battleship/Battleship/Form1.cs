...
namespace Battleship
{
     public partial class Form1 : Form
    {
            ...
            using (System.IO.StreamWriter file = new System.IO.StreamWriter(@sName))
            {
                for (int i = 1; i <= 10; i++)
                {
                    for (int j = 1; j <= 10; j++)
                    {
                        ...
                        {
                            case 1:
                                sText = Convert.ToString(_enemy1[j - 1]);
                                break;
                            case 2:
                                sText = Convert.ToString(_enemy2[j - 1]);
                                break;
                            case 3:
                                sText = Convert.ToString(_enemy3[j - 1]);
                                break;
                            case 4:
                                sText = Convert.ToString(_enemy4[j - 1]);
                                break;
                            case 5:
                                sText = Convert.ToString(_enemy5[j - 1]);
                                break;
                            case 6:
                                sText = Convert.ToString(_enemy6[j - 1]);
                                break;
                            case 7:
                                sText = Convert.ToString(_enemy7[j - 1]);
                                break;
                            case 8:
                                sText = Convert.ToString(_enemy8[j - 1]);
                                break;
                            case 9:
                                sText = Convert.ToString(_enemy9[j - 1]);
                                break;
                            case 10:
                                sText = Convert.ToString(_enemya[j - 1]);
                                break;
                        }
        ...
        private void btnDrop1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        case 1:
                            nType = _enemy1[CounterRow - 1];
                            break;
                        case 2:
                            nType = _enemy2[CounterRow - 1];
                            break;
                        case 3:
                            nType = _enemy3[CounterRow - 1];
                            break;
                        case 4:
                            nType = _enemy4[CounterRow - 1];
                            break;
                        case 5:
                            nType = _enemy5[CounterRow - 1];
                            break;
                        case 6:
                            nType = _enemy6[CounterRow - 1];
                            break;
                        case 7:
                            nType = _enemy7[CounterRow - 1];
                            break;
                        case 8:
                            nType = _enemy8[CounterRow - 1];
                            break;
                        case 9:
                            nType = _enemy9[CounterRow - 1];
                            break;
                        default:
                            nType = _enemya[CounterRow - 1];
                            break;
                    }
                    ...
                    switch (nType)
                    {
                        case 2:
                            ...
                            {
                                case 1:
                                    _enemy1[CounterRow - 1] = nDrop;
                                    break;
                                case 2:
                                    _enemy2[CounterRow - 1] = nDrop;
                                    break;
                                case 3:
                                    _enemy3[CounterRow - 1] = nDrop;
                                    break;
                                case 4:
                                    _enemy4[CounterRow - 1] = nDrop;
                                    break;
                                case 5:
                                    _enemy5[CounterRow - 1] = nDrop;
                                    break;
                                case 6:
                                    _enemy6[CounterRow - 1] = nDrop;
                                    break;
                                case 7:
                                    _enemy7[CounterRow - 1] = nDrop;
                                    break;
                                case 8:
                                    _enemy8[CounterRow - 1] = nDrop;
                                    break;
                                case 9:
                                    _enemy9[CounterRow - 1] = nDrop;
                                    break;
                                default:
                                    _enemya[CounterRow - 1] = nDrop;
                                    break;
                            }
                            break;
                        case 7:
                            ...
                            {
                                case 1:
                                    _enemy1[CounterRow - 1] = 3;
                                    break;
                                case 2:
                                    _enemy2[CounterRow - 1] = 3;
                                    break;
                                case 3:
                                    _enemy3[CounterRow - 1] = 3;
                                    break;
                                case 4:
                                    _enemy4[CounterRow - 1] = 3;
                                    break;
                                case 5:
                                    _enemy5[CounterRow - 1] = 3;
                                    break;
                                case 6:
                                    _enemy6[CounterRow - 1] = 3;
                                    break;
                                case 7:
                                    _enemy7[CounterRow - 1] = 3;
                                    break;
                                case 8:
                                    _enemy8[CounterRow - 1] = 3;
                                    break;
                                case 9:
                                    _enemy9[CounterRow - 1] = 3;
                                    break;
                                default:
                                    _enemya[CounterRow - 1] = 3;
                                    break;
                            }
                            break;
                        case 8:
        ...
        private void btnDrop3_Click(object sender, EventArgs e)
        {
            Random rnd1 = new Random();
            int nCol, nRow, nType;
            int nDrop = 6;
