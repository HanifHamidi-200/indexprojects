...
namespace BottleLearnings
{
    public partial class Form1 : Form
    {
        ...
        private void fUpdateDisplay()
        {
            ...
            {
                Name = "pictureBox1",
                Image = Image.FromFile(@"F Angel 1.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture2 = new PictureBox
            {
                Name = "pictureBox2",
                Image = Image.FromFile(@"F Plumbing 1.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture3 = new PictureBox
            {
                Name = "pictureBox3",
                Image = Image.FromFile(@"F Plumbing 2.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture4 = new PictureBox
            {
                Name = "pictureBox4",
                Image = Image.FromFile(@"F Structures 1a.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture5 = new PictureBox
            {
                Name = "pictureBox5",
                Image = Image.FromFile(@"F Structures 1b.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture6 = new PictureBox
            {
                Name = "pictureBox6",
                Image = Image.FromFile(@"F Structures 1c.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture7 = new PictureBox
            {
                Name = "pictureBox7",
                Image = Image.FromFile(@"F Structures 2a.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture8 = new PictureBox
            {
                Name = "pictureBox8",
                Image = Image.FromFile(@"F Structures 2b.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture9 = new PictureBox
            {
                Name = "pictureBox9",
                Image = Image.FromFile(@"F Structures 2c.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 1; i <= 8; i++)
            {
                _col1[i - 1] = rnd1.Next(1, 11);
                _col2[i - 1] = rnd1.Next(1, 11);
                _col3[i - 1] = rnd1.Next(1, 11);
                _col4[i - 1] = rnd1.Next(1, 11);
                _col5[i - 1] = rnd1.Next(1, 11);
                _col6[i - 1] = rnd1.Next(1, 11);
                _col7[i - 1] = rnd1.Next(1, 11);
                _col8[i - 1] = rnd1.Next(1, 11);
            }
