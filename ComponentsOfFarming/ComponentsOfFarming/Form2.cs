...
namespace ComponentsOfFarming
{
    public partial class Form2 : Form
    {
        ...
        private int nNumber;
        private static List<int> _coordinates1 = new List<int> { 0, 0 };
        private static List<int> _coordinates2 = new List<int> { 0, 0 };
        private static List<int> _coordinates3 = new List<int> { 0, 0 };
        private int mnRowItem;
        private int mnSavecol, mnSaverow,mnDirection;
        private int mnPredictcol, mnPredictrow;
        ...
        private bool fValid(int nCol,int nRow)
        {
            ...
            switch (mnRowItem)
            {
                ...
                case 2:
                    ...
                    {
                        case 1:
                            bNext = fNext(mnSavecol, mnSaverow, nCol, nRow);
                            mnSavecol = nCol;
                            mnSaverow = nRow;
                            fPredict();
                            return bNext;
                ...
                default:
                    if (nCol == mnPredictcol)
                    {
                        if (nRow == mnPredictrow)
                        {
                            return true;
                        }
                    }
        ...
        private void fPick(int nCol,int nRow)
        {
            ...
            {
                case 1:
                    _coordinates1[0] = nCol;
                    _coordinates1[1] = nRow;
                    bValid = fValid(nCol, nRow);
                    if (bValid == false)
                    {
                    ...
                    break;
                case 2:
                    _coordinates2[0] = nCol;
                    _coordinates2[1] = nRow;
                    bValid = fValid(nCol, nRow);
                    if (bValid == false)
                    {
                        MessageBox.Show("Error!");
                    ...
                    break;
                default:
                    _coordinates3[0] = nCol;
                    _coordinates3[1] = nRow;
                    bValid = fValid(nCol, nRow);
                    if (bValid == false)
                    {
                        MessageBox.Show("Error!");
