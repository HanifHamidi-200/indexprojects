...
namespace ControlOftheSituation
{
    public partial class Form1 : Form
    {
        ...
        private int mnBuildCol, mnBuildRow;
        private bool mbStation;
        private int mnMode;
        ...
        {
            Random rnd1 = new Random();
            int nStations = rnd1.Next(4, 17);
            int nRoads = rnd1.Next(2, 11);
            int nMode;
            int nCol, nRow, nType;
        ...
        private void fUpdateSelected()
        {
            String sText = "SELECTED = " + Convert.ToString(mnCol) + "," + Convert.ToString(mnRow);
            int nType=0;
        ...
        private void fUpdateDisplay()
        {
            ...
            {
                Name = "pictureBox2",
                Image = Image.FromFile(@"F CompoundedFormula.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture3 = new PictureBox
            {
                Name = "pictureBox3",
                Image = Image.FromFile(@"F Extended.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture4 = new PictureBox
            {
                Name = "pictureBox4",
                Image = Image.FromFile(@"F Memalsukan.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture5 = new PictureBox
            {
                Name = "pictureBox5",
                Image = Image.FromFile(@"F PulpugatedAffair.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            ...
            {
                Name = "pictureBox7",
                Image = Image.FromFile(@"F Shootdown.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture8 = new PictureBox
            {
                Name = "pictureBox8",
                Image = Image.FromFile(@"F StartBuilding.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture9 = new PictureBox
            {
                Name = "pictureBox9",
                Image = Image.FromFile(@"F StronglyTyped.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
