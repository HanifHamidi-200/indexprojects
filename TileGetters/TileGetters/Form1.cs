    ...
    public partial class Form1 : Form
    {
        ...
        private void fChance(String sLetter,int nLetter)
        {
            ...
            if (mbExpire)
            {
                ...
                {
                    sLetter2 = sAnswer2.Substring(nLetter - 1, 1);
                    sAnswer1 = sAnswer1.Substring(0, nLetter - 1) + sLetter2 + sAnswer1.Substring(nLetter, 16 - nLetter);
                    sAnswer3 = sAnswer3.Substring(0, nLetter - 1) + sLetter2 + sAnswer3.Substring(nLetter, 16 - nLetter);
                    nScore += 10;
